...
//    }
    ...
    public Page<ReviewResponseDto> searchReview(Long userId, String storeName, BigDecimal star, Pageable pageable) {

        Page<Review> reviews = reviewQueryDsl.search(userId, storeName, star, pageable);
